...
In this project, we will make attempts to predict day-ahead stock prices with only historical price data using different approaches. As we learned in lectures, the ARIMA model is a popular option when it comes 
...
### Stock Price Prediction Using Recurrent Neural Networks (2018)\[#\]
...
Vo, Nguyen, and Robert Slepaczuk. Entropy, 20 Jan. 2022, <https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8870867/pdf/entropy-24-00158.pdf.>
